...
import SEMANTIC_SORTING_SELL_SHEET_IMAGE from "../assets/img/semantic-sorting/north-star-sell-sheet.png";
import SEMANTIC_SORTING_SELL_SHEET_PDF from "../assets/download/north-star-sell-sheet.pdf";
...
export const PROJECT_SEMANTIC_SORTING: Project = {
  ...
  description: (
    <>
      North Star is a co-operative word guessing party game. One player knows a
      secret word and must clue the other players by carefully arranging their
      guesses, bringing them closer and closer to the correct answer over the
      course of the game.
    </>
  ),
